...
public class caseMethod {
    public static void main(String[] args) {
        ...
        double finalScore1, finalScore2, finalScore3, averageFinalScore;
        String letterGrade1 = null, letterGrade2 = null, letterGrade3 = null, status1 = null, status2 = null, status3 = null, semesterStatus;
        ...
        System.out.print("MidTerm Score: ");
        double midTerm3 = ans.nextDouble();
        System.out.print("FinalExam Score: ");
        double finalExam3 = ans.nextDouble();
        System.out.print("Assignment Score: ");
        double Assignment3 = ans.nextDouble();
        ...
        finalScore3 = (midTerm3 * 0.3) + (finalExam3 * 0.4) + (Assignment3 * 0.3);
        ...
        if (finalScore3 >80 && finalScore3 <= 100) {
            ...
            letterGrade1 = "B";
            status1 = "PASS";
        } else if (finalScore3 > 60 && finalScore3 <= 65) {
            letterGrade1 = "C+";
            status1 = "PASS";
        ...
        averageFinalScore = (finalScore1 + finalScore2 + finalScore3) / 3;
        ...
        System.out.printf("%-25s %-8.1f %-8.1f %-8.1f %-14.2f %-10s %-15s%n", "Basic English", midTerm3,  finalExam3,  Assignment3, finalScore3, letterGrade3, status3 + "\n");
